...
This directory holds non-code reference artifacts that are useful for context but are not part of the core automated test path.

Contents:

- `ER4971006_Redacted.pdf`
- `ER5499574_Redacted.pdf`
